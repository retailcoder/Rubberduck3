...
{
    public VBCompareLessThanOperator(WorkspaceUri parentUri, string lhsExpression, string rhsExpression, TypedSymbol? lhs = null, TypedSymbol? rhs = null)
        : base(Tokens.CompareLessThanOp, parentUri, lhsExpression, rhsExpression, lhs, rhs)
    {
    }
