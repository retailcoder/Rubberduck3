...
{
    public VBCompareGreaterThanOrEqualOperator(WorkspaceUri parentUri, ValuedExpression lhs, ValuedExpression rhs)
        : base(Tokens.CompareGreaterThanOrEqualOp, parentUri, lhs, rhs)
    {
    }
