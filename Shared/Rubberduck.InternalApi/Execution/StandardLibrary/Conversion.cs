...
namespace Rubberduck.InternalApi.Execution.StandardLibrary
{
    public static class Conversion
    {
        ...
        public static VBByteValue CByte(VBExecutionContext context, TypedSymbol symbol, VBTypedValue value) =>
            CheckNullError(value, e => new VBByteValue(symbol).WithValue(e.Value), out var nop)
                ? nop : new VBByteValue(symbol).WithValue(GetNumericValueOrThrow(context, value));

        public static VBCurrencyValue CCur(VBExecutionContext context, TypedSymbol symbol, VBTypedValue value) =>
            CheckNullError(value, e => new VBCurrencyValue(symbol).WithValue(e.Value), out var nop)
                ? nop : new VBCurrencyValue(symbol).WithValue(GetNumericValueOrThrow(context, value));
        ...
        public static VBDateValue CDate(VBExecutionContext context, VBTypedValue value)
        {
            ...
            {
                // from serial
                return new VBDateValue(value.Symbol!).WithValue(numeric);
            }
        ...
        public static VBDoubleValue CDbl(VBExecutionContext context, TypedSymbol symbol, VBTypedValue value) =>
            CheckNullError(value, e => new VBDoubleValue(symbol).WithValue(e.Value), out var nop)
                ? nop : new VBDoubleValue(symbol).WithValue(GetNumericValueOrThrow(context, value));
        ...
        public static VBDecimalValue CDec(VBExecutionContext context, TypedSymbol symbol, VBTypedValue value) =>
            CheckNullError(value, e => new VBDecimalValue(symbol).WithValue(e.Value), out var nop)
                ? nop : new VBDecimalValue(symbol).WithValue(GetNumericValueOrThrow(context, value));

        public static VBIntegerValue CInt(VBExecutionContext context, TypedSymbol symbol, VBTypedValue value) =>
            CheckNullError(value, e => new VBIntegerValue(symbol).WithValue(e.Value), out var nop)
                ? nop : new VBIntegerValue(symbol).WithValue(GetNumericValueOrThrow(context, value));

        public static VBLongValue CLng(VBExecutionContext context, TypedSymbol symbol, VBTypedValue value) =>
            CheckNullError(value, e => new VBLongValue(symbol).WithValue(e.Value), out var nop)
                ? nop : new VBLongValue(symbol).WithValue(GetNumericValueOrThrow(context, value));

        public static VBLongLongValue CLngLng(VBExecutionContext context, TypedSymbol symbol, VBTypedValue value) =>
            CheckNullError(value, e => new VBLongLongValue(symbol).WithValue(e.Value), out var nop)
                ? nop : new VBLongLongValue(symbol).WithValue(GetNumericValueOrThrow(context, value));
        ...
        public static VBLongPtrValue CLngPtr(VBExecutionContext context, TypedSymbol symbol, VBTypedValue value)
        {
            ...
            return CheckNullError(value, e => new VBLongPtrValue(symbol).WithValue(e.Value, ptrSize), out var nop)
                ? nop : new VBLongPtrValue(symbol).WithValue(GetNumericValueOrThrow(context, value), ptrSize);
        }

        public static VBSingleValue CSng(VBExecutionContext context, TypedSymbol symbol, VBTypedValue value) =>
            CheckNullError(value, e => new VBSingleValue(symbol).WithValue(e.Value), out var nop)
                ? nop : new VBSingleValue(symbol).WithValue(GetNumericValueOrThrow(context, value));
        ...
        public static VBStringValue CStr(VBExecutionContext context, TypedSymbol symbol, VBTypedValue value) =>
            CheckNullError(value, null as Func<VBTypedValue, VBStringValue>, out var nop)
                ? nop : new VBStringValue(symbol).WithValue(GetStringValueOrThrow(value));
